---
title: "Xaringan"
subtitle: "A theme for UNSW"
author: "Fangzhou Yu"
date: "27 May 2021"
output:
  xaringan::moon_reader:
    css: ["default", "assets/unsw-fonts.css", "assets/unsw.css"]
...
This template is a modified version of the template for USyd by **Dr. Garth Tarr**. 

The modifications are simply changing theme colors and Uni logos. The problem with using **icons** package due to the update of the package is fixed.

The original template for USyd are available in the GitHub code repository [`r icons::fontawesome("github")` `garthtarr/sydney_xaringan`](http://github.com/garthtarr/sydney_xaringan/assets)
...
For more info see [the `r icons::fontawesome("github")` repo](https://github.com/ropenscilabs/icon).
...
We can do this with white, .brand-red[UNSW red], .brand-blue[UNSW blue], .brand-yellow[UNSW yellow], .brand-gold[UNSW gold], .brand-grey[UNSW grey], .black[black], .red[red], .blue[blue], .green[green], .yellow[yellow], .orange[orange], .purple[purple], .grey[grey].
...
.footnote[The background of this slide is UNSW Yellow because the slide began with:
```
---
class: unsw-yellow
```
...
---
class: middle, bottom
background-image: url("assets/unsw-logo.svg")
background-size: 50%
...
## .white[Title for unsw-red class]
...
---
class: title-slide
background-image: url("assets/unsw-logo-black.svg"), url("assets/title-image2.jpg")
...
---
class: title-slide
background-image: url("assets/unsw-logo.svg"), url("assets/title-image1.jpg")
background-position: 10% 90%, 100% 50%
background-size: 160px, 100% 100%

# .text-shadow[.white[Manual title slide (title-image.1)]]
...
---
class: title-slide
background-image: url("assets/unsw-logo-white.svg"), url("assets/title-image1.jpg")
background-position: 10% 90%, 100% 50%
...
Equation numbering isn't part of the standard xaringan package but I've included it with the UNSW theme.  This is enabled with the inclusion of the `in_header` line in the YAML with reference to the file `mathjax-equation-numbers.html` which needs to be in an appropriate location.
